...
class OrderCustomFieldsStruct extends Struct
{
    ...
    protected ?string $checkoutReturnUrl = null;

    protected ?string $transactionReturnUrl = null;

    public function __construct(?string $checkoutPaymentId = null, ?string $checkoutReturnUrl = null, ?string $transactionReturnUrl = null)
    {
